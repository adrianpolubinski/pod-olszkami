    ...
    ${props=> {
        if(props.black)
            return `
                ...
                &:hover {
                    filter: drop-shadow(1px 1px 1px cadetblue)
                }
            `;
    }};

    ${props=> {
        if(props.resizeByWidth)
            return `
                width: 100%; 
                height: auto;
            `;
...
function Brand( {black, resizeByWidth, resizeByHeight} ) {
    return (
        <Svg black={black} resizeByWidth={resizeByWidth} resizeByHeight={resizeByHeight} version="1.0" xmlns="http://www.w3.org/2000/svg"
            width="485.000000pt" height="343.000000pt" viewBox="0 0 485.000000 343.000000"
            preserveAspectRatio="xMidYMid meet">
            <title>Brand</title>
            <g transform="translate(0.000000,343.000000) scale(0.100000,-0.100000)"
            fill={black ? "#000": "#fff"} stroke="none">
